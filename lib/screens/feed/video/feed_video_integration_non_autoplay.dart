...
import 'package:insta_feed/screens/feed/video/reusable/reusable_video_list_widget_clean_no_autoplay.dart';
...
class FeedVideoIntegrationNonAutoplay extends StatefulWidget {
  const FeedVideoIntegrationNonAutoplay({Key? key}) : super(key: key);

  @override
  State<FeedVideoIntegrationNonAutoplay> createState() =>
      _FeedVideoIntegrationNonAutoplayState();
}

class _FeedVideoIntegrationNonAutoplayState
    extends State<FeedVideoIntegrationNonAutoplay> {
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return FrameSeparateWidget(
                    ...
                    child: ReusableVideoListWidgetCleanNoAutoplay(
