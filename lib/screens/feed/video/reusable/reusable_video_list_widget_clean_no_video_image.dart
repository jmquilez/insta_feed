...
//NOTE: NO CONTROLS EITHER

//KEY NOTE: TOO MANY EVENT LISTENERS CAUSE JANK (TEST WITHOUT REMOVING THEM)
class ReusableVideoListWidgetCleanNoVideoImage extends StatefulWidget {
  ...
  const ReusableVideoListWidgetCleanNoVideoImage(
      {Key? key,
      this.videoListData,
  ...
  @override
  _ReusableVideoListWidgetCleanNoVideoImageState createState() =>
      _ReusableVideoListWidgetCleanNoVideoImageState();
}

class _ReusableVideoListWidgetCleanNoVideoImageState
    extends State<ReusableVideoListWidgetCleanNoVideoImage> {
