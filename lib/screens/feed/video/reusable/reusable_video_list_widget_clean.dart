...
class ReusableVideoListWidgetClean extends StatefulWidget {
  ...
  const ReusableVideoListWidgetClean(
      {Key? key,
      this.videoListData,
  ...
  @override
  _ReusableVideoListWidgetCleanState createState() =>
      _ReusableVideoListWidgetCleanState();
}

class _ReusableVideoListWidgetCleanState
    extends State<ReusableVideoListWidgetClean> {
