...
class ReusableVideoListWidgetCleanNoAutoplay extends StatefulWidget {
  ...
  const ReusableVideoListWidgetCleanNoAutoplay(
      {Key? key,
      this.videoListData,
  ...
  @override
  _ReusableVideoListWidgetCleanNoAutoplayState createState() =>
      _ReusableVideoListWidgetCleanNoAutoplayState();
}

class _ReusableVideoListWidgetCleanNoAutoplayState
    extends State<ReusableVideoListWidgetCleanNoAutoplay> {
